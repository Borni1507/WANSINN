...
_HEALTH_EN_EXACT = {
    ...
    "Veraltete RouterOS-Version erkannt.": "Outdated RouterOS version detected.",
    "RouterOS 7.19.6 zeigte im Hardwaretest fehlerhaftes Policy-Routing bei WAN-Healthchecks.": "RouterOS 7.19.6 showed incorrect policy routing during WAN health checks in hardware testing.",
    "Bitte RouterOS vor der WANSINN-Fehlersuche auf eine aktuelle stable/long-term Version aktualisieren.": "Update RouterOS to a current stable/long-term version before troubleshooting WANSINN.",
...
_RUNTIME_EN = {
    ...
    "Die Router-Liste 'internal-networks' fehlt und WANSINN konnte kein internes IPv4-Netz sicher automatisch erkennen. Bitte LAN/VLAN-Konfiguration des Routers prüfen.": "The router list 'internal-networks' is missing and WANSINN could not safely auto-detect an internal IPv4 network. Please check the router's LAN/VLAN configuration.",
    "WANSINN konnte die Router-Liste 'internal-networks' nicht anlegen.": "WANSINN could not create the router list 'internal-networks'.",
